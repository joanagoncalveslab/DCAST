            ...
            for seed_run in range(10):
                ...
                for diversity in [None, 10, 100]:#50, 100, 200]:  # 3,5,10,None
                    try:
                        ...
                        model_dict['models'][f'{fold}'][f'{seed_run}'][f'ST_{diversity}'] = {'model': None, 'loss': loss_st,
...
if args.dataset == 'cifar':
    ...
    dataset = {'name': args.dataset, 'args': {}, 'order': 'train_test_unlabeled_bias_validation',
               'train': 0.3, 'test': 0.2, 'unlabeled': 0.7, 'val': 0.2, 'runs': (args.fold_start,args.fold_start+5)}
bias_list = []
