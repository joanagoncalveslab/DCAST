        ...
        for fold in range(model_dict['params']['dataset']['runs']):
            ...
            for seed_run in range(10):
                ...
                try:
                    ...
                    model_dict['models'][f'{fold}'][f'{seed_run}'][f'ST_th'] = {'model': None, 'loss': loss_st_th, 'auroc': auroc_st_th, 
                                                                 'auprc': auprc_st_th, 'acc': acc_st_th, 'end_sample_size': end_size_th}
                    res.append([f'ST_th', len(y_b_train), end_size_th, fold, seed_run, loss_st_th, auroc_st_th, auprc_st_th,acc_st_th])
                ...
                try:
                    ...
                    model_dict['models'][f'{fold}'][f'{seed_run}'][f'ST_kb'] = {'model': None, 'loss': loss_st_kb, 'auroc': auroc_st_kb, 
                                                                 'auprc': auprc_st_kb,'acc': acc_st_kb, 'end_sample_size': end_size_kb}
                    res.append([f'ST_kb', len(y_b_train), end_size_kb, fold, seed_run, loss_st_kb, auroc_st_kb, auprc_st_kb, acc_st_kb])
                ...
                for mi in [100]:  # [50,100]:
                    for val_base in [False]:#, True]:
                        ...
                        try:
                            ...
                            ds_folder_name = '_'.join(ds_folder_name_list)
                            res_fold = 'results_nn_extra_test_nb_imb_fin_cw3_ss8'
