...
from src.models.nn_fsd_self_training import NNDiverseSelfTraining
...
def selection_bias_trial(model_dict, out_loc):
    ...
    res_folder = config.ROOT_DIR / 'results_fsdnn_test_nb_imb_fin_cw3_ss' / f'{model_dict["params"]["bias"]["name"]}' / ds_folder_name
                ...
                for mi in [100]:  # [50,100]:
                    for val_base in [False, True]:
                        ...
                        try:
                            ...
                            ds_folder_name = '_'.join(ds_folder_name_list)
                            log_loc = config.ROOT_DIR / 'results_fsdnn_test_nb_imb_fin_cw3_ss' / f'{model_dict["params"]["bias"]["name"]}' / ds_folder_name / f'{out_loc}.log'
