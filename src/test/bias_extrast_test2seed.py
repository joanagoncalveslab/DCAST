        ...
        for fold in range(model_dict['params']['dataset']['runs']):
            try:
                ...
                for seed_run in range(10):
                    ...
                    su_clf = lgb.LGBMClassifier(boosting_type="rf", **base_m_params, random_state=R_STATE+fold+seed_run)
                    if model_dict['params']['model']['val_base']:
                    ...
                    try:
                        ...
                        base_th_clf = lgb.LGBMClassifier(boosting_type="rf", **base_m_params, random_state=R_STATE+fold+seed_run)
                        np.random.seed(R_STATE+fold+seed_run)
                        ...
                        st_th_clf.fit(x_b_tr_val_unk.copy(), y_b_tr_val_unk.copy())
                        ...
                        model_dict['models'][f'{fold}'][f'{seed_run}'][f'ST_th'] = {'model': model_dict, 'loss': loss_st_th, 'auroc': auroc_st_th, 
                    ...
                    try:
                        ...
                        st_kb_clf = SelfTrainingClassifier(base_kb_clf, criterion='k_best', k_best=model_dict['params']['model']['k_best'], 
                                                           verbose=False, max_iter=model_dict['params']['model']['max_iter'])
                        st_kb_clf.fit(x_b_tr_val_unk.copy(), y_b_tr_val_unk.copy())
                        ...
                        model_dict['models'][f'{fold}'][f'{seed_run}'][f'ST_kb'] = {'model': model_dict, 'loss': loss_st_kb, 'auroc': auroc_st_kb, 
                ...
                for mi in [100]:
                    for val_base in [False]:#, True]:
                        ...
                        try:
                            ...
                            [ds_folder_name_list.append(str(val)) for val in model_dict["params"]["dataset"]["args"].values()]
                            ds_folder_name = '_'.join(ds_folder_name_list)
                            res_fold ='results_extra_test_nb_imb_ss8'
