        ...
        for fold in range(model_dict['params']['dataset']['runs']):
            if True:#try:
                ...
                for seed_run in range(10):
                    ...
                    model_dict['models'][f'{fold}'][f'{seed_run}'][f'SU'] = {'model': None, 'loss': loss_su, 'auroc': auroc_su,
                    ...
                    model_dict['models'][f'{fold}'][f'{seed_run}'][f'KMM_cw'] = {'model': None, 'loss': loss_kmm_cw, 'auroc': auroc_kmm_cw,
                                                              'auprc': auprc_kmm_cw, 'acc': acc_kmm_cw,
                                                              'sample_size': len(y_b_train_val)}
                    res.append(['KMM_cw', len(y_b_train_val), len(y_b_train_val), fold, seed_run, loss_kmm_cw, auroc_kmm_cw, auprc_kmm_cw, acc_kmm_cw])
                    ...
                    model_dict['models'][f'{fold}'][f'KMM'] = {'model': None, 'loss': loss_kmm, 'auroc': auroc_kmm,
                                                              'auprc': auprc_kmm, 'acc': acc_kmm,
                                                              'sample_size': len(y_b_train_val)}
                    res.append(['KMM', len(y_b_train_val), len(y_b_train_val), fold, seed_run, loss_kmm, auroc_kmm, auprc_kmm, acc_kmm])
                ...
                for mi in [100]:  # [50,100]:
                    for val_base in [False]:#, True]:
                        ...
                        try:
                            ...
                            ds_folder_name = '_'.join(ds_folder_name_list)
                            res_folder = 'results_kmm_nn_test_nb_imb_ss8'
