            ...
            try:
                ...
                for seed_run in range(10):
                    ...
                    for diversity in [None, 10, 100]: #3,5,10,None
                        try:
                            np.random.seed(R_STATE+fold+seed_run)
                            base_clf = LogisticRegression(multi_class='auto', penalty='l2', max_iter=1000, class_weight='balanced', random_state=R_STATE+fold+seed_run, C=5)
                            ...
                            model_dict['models'][f'{fold}'][f'{seed_run}'][f'ST_{diversity}'] = {'model': st_clf, 'loss': loss_st, 'auroc': auroc_st, 'auprc': auprc_st, 'acc': acc_st,
