...
def kernel_mean_matching(X, Z, kern='lin', B=1, eps=None):
    nx = X.shape[0]
    nz = Z.shape[0]
    if eps == None:
        eps = B / math.sqrt(nz)
        #eps = (math.sqrt(nz) - 1) / math.sqrt(nz)
    if kern == 'lin':
        K = np.dot(Z, Z.T)
...
def main():
    ...
    train_data_set,train_classList,train_maxVar=read_data_set("../../datasets/apps_data_k100/datafile-qrsnc2a7k20.c0.d4.C23.N2000.t16.T4.D1.E1.F1.G1.H1.I1.B16.J8.K300.L0.05.M100.A1.V0.P0.G0.l0.0.b600-train.arff")
    # reading test data file
    test_data_set,test_classList,test_maxVar=read_data_set("../../datasets/apps_data_k100/datafile-qrsnc2a7k20.c0.d4.C23.N2000.t16.T4.D1.E1.F1.G1.H1.I1.B16.J8.K300.L0.05.M100.A1.V0.P0.G0.l0.0.b600-test.arff")
